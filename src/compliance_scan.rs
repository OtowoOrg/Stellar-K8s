...
impl CisBenchmarkScanner {
    ...
    async fn run_custom_policies(&self) -> Result<Vec<ComplianceFinding>, anyhow::Error> {
        ...
        for policy_path in &self.config.custom_policies {
            // Load and evaluate custom policies (OPA/Rego)
    ...
    async fn evaluate_opa_policy(&self, policy_path: &str) -> Result<Vec<ComplianceFinding>, anyhow::Error> {
        ...
        // In a real implementation, this would use OPA SDK to evaluate policies
    ...
    fn generate_summary(&self, findings: &[ComplianceFinding]) -> ScanSummary {
        ...
        for finding in findings {
            ...
            *summary.by_framework.entry(finding.framework.clone()).or_insert(0) += 1;
            ...
            // For simplicity, consider FAIL/High/Critical as failed
            // In reality, this would be based on actual pass/fail
